...
namespace FishyRealtime
{
    ...
    public struct Room
    {
        ...
        /// <summary>
        /// How much players are on this room, changing this won't do anything to the room itself
        /// </summary>
    ...
    [InitializeOnLoad]
#endif
    public class FishyRealtime : Transport, IConnectionCallbacks, IMatchmakingCallbacks, IOnEventCallback, ILobbyCallbacks
    {
